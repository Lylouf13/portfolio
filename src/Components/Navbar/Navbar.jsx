...
export default function Navbar() {
  ...
  return (
    <nav className='navbar'>
        <Link to="/Portfolio" className={`navbar__link ${location.pathname==="/"? "navbar__link-current" : ""}`}>Home</Link>
        ...
        <Link to="/Portfolio/pixelArt" className={`navbar__link ${location.pathname==="/pixelArt"? "navbar__link-current" : ""}`}>Pixel Art</Link>
    </nav>
  )
}
